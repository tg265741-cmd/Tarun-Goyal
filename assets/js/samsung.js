...
(function () {
  ...
  const IC = {
    logo: '<svg viewBox="0 0 32 32" fill="none"><path d="M16 2 29 7v8c0 8-5.5 13.4-13 15C8.5 28.4 3 23 3 15V7z" stroke="#034ea2" stroke-width="2"/><circle cx="18.5" cy="11.5" r="1.5" fill="#034ea2"/></svg>',
  ...
  window.Gcard = function (p) {
    ...
    const tag = p.soldOut ? '<span class="tag grey">Sold out</span>'
      : p.badge === 'flagship' ? '<span class="tag blue">Flagship</span>'
      : p.badge === 'new' ? '<span class="tag blue">New</span>'
